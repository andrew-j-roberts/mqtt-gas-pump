...
var DashboardConsumer = function (queueName) {
    'use strict';
    var consumer = {};
    ...
    consumer.connect = function () {
        ...
        var hosturl =  pubsubplus_config.solace_ws_host;
        var username = pubsubplus_config.username;
        var pass = pubsubplus_config.password;
        var vpn = pubsubplus_config.vpn;
